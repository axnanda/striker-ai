...
class SpecialistPoolServiceRestInterceptor:
    """Interceptor for SpecialistPoolService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the SpecialistPoolServiceRestTransport.

    .. code-block:: python
        class MyCustomSpecialistPoolServiceInterceptor(SpecialistPoolServiceRestInterceptor):
            def pre_create_specialist_pool(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_create_specialist_pool(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_delete_specialist_pool(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_delete_specialist_pool(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_get_specialist_pool(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_specialist_pool(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_specialist_pools(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_specialist_pools(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_update_specialist_pool(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_specialist_pool(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = SpecialistPoolServiceRestTransport(interceptor=MyCustomSpecialistPoolServiceInterceptor())
...
class SpecialistPoolServiceRestTransport(SpecialistPoolServiceTransport):
    """REST backend transport for SpecialistPoolService.
    ...
    class _CreateSpecialistPool(SpecialistPoolServiceRestStub):
        def __hash__(self):
            return hash("CreateSpecialistPool")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{parent=projects/*/locations/*}/specialistPools",
            ...
            pb_request = specialist_pool_service.CreateSpecialistPoolRequest.pb(request)
    ...
    class _DeleteSpecialistPool(SpecialistPoolServiceRestStub):
        def __hash__(self):
            return hash("DeleteSpecialistPool")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1beta1/{name=projects/*/locations/*/specialistPools/*}",
                },
            ]
            request, metadata = self._interceptor.pre_delete_specialist_pool(
                request, metadata
            )
            pb_request = specialist_pool_service.DeleteSpecialistPoolRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetSpecialistPool(SpecialistPoolServiceRestStub):
        def __hash__(self):
            return hash("GetSpecialistPool")
        ...
        def __call__(
            ...
            *,
            ...
            pb_request = specialist_pool_service.GetSpecialistPoolRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListSpecialistPools(SpecialistPoolServiceRestStub):
        def __hash__(self):
            return hash("ListSpecialistPools")
        ...
        def __call__(
            ...
            *,
            ...
            pb_request = specialist_pool_service.ListSpecialistPoolsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _UpdateSpecialistPool(SpecialistPoolServiceRestStub):
        def __hash__(self):
            return hash("UpdateSpecialistPool")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1beta1/{specialist_pool.name=projects/*/locations/*/specialistPools/*}",
                    "body": "specialist_pool",
                },
            ]
            ...
            pb_request = specialist_pool_service.UpdateSpecialistPoolRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetLocation(SpecialistPoolServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.GetLocationRequest,
            *,
    ...
    class _ListLocations(SpecialistPoolServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.ListLocationsRequest,
            *,
    ...
    class _GetIamPolicy(SpecialistPoolServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.GetIamPolicyRequest,
            *,
    ...
    class _SetIamPolicy(SpecialistPoolServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.SetIamPolicyRequest,
            *,
    ...
    class _TestIamPermissions(SpecialistPoolServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.TestIamPermissionsRequest,
            *,
    ...
    class _CancelOperation(SpecialistPoolServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.CancelOperationRequest,
            *,
    ...
    class _DeleteOperation(SpecialistPoolServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.DeleteOperationRequest,
            *,
    ...
    class _GetOperation(SpecialistPoolServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,
    ...
    class _ListOperations(SpecialistPoolServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.ListOperationsRequest,
            *,
    ...
    class _WaitOperation(SpecialistPoolServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.WaitOperationRequest,
            *,
