...
class EvaluationServiceAsyncClient:
    ...
    get_transport_class = functools.partial(
        type(EvaluationServiceClient).get_transport_class, type(EvaluationServiceClient)
    )
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, EvaluationServiceTransport] = "grpc_asyncio",
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_evaluate_instances():
                # Create a client
                client = aiplatform_v1beta1.EvaluationServiceAsyncClient()
                ...
                # Make the request
                response = await client.evaluate_instances(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.EvaluateInstancesRequest, dict]]):
        ...
        rpc = gapic_v1.method_async.wrap_method(
            self._client._transport.evaluate_instances,
