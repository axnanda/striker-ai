...
class ReasoningEngineServiceTransport(abc.ABC):
    """Abstract transport class for ReasoningEngineService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_reasoning_engine: gapic_v1.method.wrap_method(
                self.create_reasoning_engine,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_reasoning_engine: gapic_v1.method.wrap_method(
                self.get_reasoning_engine,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_reasoning_engines: gapic_v1.method.wrap_method(
...
__all__ = ("ReasoningEngineServiceTransport",)
