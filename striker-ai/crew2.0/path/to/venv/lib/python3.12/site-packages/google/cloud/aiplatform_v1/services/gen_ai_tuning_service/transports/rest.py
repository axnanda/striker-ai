...
class GenAiTuningServiceRestTransport(GenAiTuningServiceTransport):
    """REST backend transport for GenAiTuningService.
    ...
    class _CancelTuningJob(GenAiTuningServiceRestStub):
        def __hash__(self):
            return hash("CancelTuningJob")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{name=projects/*/locations/*/tuningJobs/*}:cancel",
                    "body": "*",
                },
            ]
            ...
            pb_request = genai_tuning_service.CancelTuningJobRequest.pb(request)
    ...
    class _CreateTuningJob(GenAiTuningServiceRestStub):
        def __hash__(self):
            return hash("CreateTuningJob")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{parent=projects/*/locations/*}/tuningJobs",
                    "body": "tuning_job",
                },
            ]
            ...
            pb_request = genai_tuning_service.CreateTuningJobRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetTuningJob(GenAiTuningServiceRestStub):
        def __hash__(self):
            return hash("GetTuningJob")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "get",
                    "uri": "/v1/{name=projects/*/locations/*/tuningJobs/*}",
                },
            ]
            request, metadata = self._interceptor.pre_get_tuning_job(request, metadata)
            pb_request = genai_tuning_service.GetTuningJobRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListTuningJobs(GenAiTuningServiceRestStub):
        def __hash__(self):
            return hash("ListTuningJobs")
        ...
        def __call__(
            ...
            *,
            ...
            pb_request = genai_tuning_service.ListTuningJobsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetLocation(GenAiTuningServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.GetLocationRequest,
            *,
    ...
    class _ListLocations(GenAiTuningServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.ListLocationsRequest,
            *,
    ...
    class _GetIamPolicy(GenAiTuningServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.GetIamPolicyRequest,
            *,
    ...
    class _SetIamPolicy(GenAiTuningServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.SetIamPolicyRequest,
            *,
    ...
    class _TestIamPermissions(GenAiTuningServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.TestIamPermissionsRequest,
            *,
    ...
    class _DeleteOperation(GenAiTuningServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.DeleteOperationRequest,
            *,
    ...
    class _WaitOperation(GenAiTuningServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.WaitOperationRequest,
            *,
