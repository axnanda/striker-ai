...
from .base import IndexServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class IndexServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the IndexServiceRestTransport.

    .. code-block:: python
        class MyCustomIndexServiceInterceptor(IndexServiceRestInterceptor):
            ...
            def pre_remove_datapoints(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_remove_datapoints(self, response):
                logging.log(f"Received response: {response}")
                return response
            ...
            def pre_upsert_datapoints(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_upsert_datapoints(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = IndexServiceRestTransport(interceptor=MyCustomIndexServiceInterceptor())
    ...
    ) -> Tuple[index_service.CreateIndexRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_delete_index(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[index_service.DeleteIndexRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_get_index(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[index_service.GetIndexRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_list_indexes(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[index_service.ListIndexesRequest, Sequence[Tuple[str, str]]]:
    ...
    def post_list_indexes(
        self, response: index_service.ListIndexesResponse
    ...
    def pre_remove_datapoints(
        self,
        request: index_service.RemoveDatapointsRequest,
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[index_service.RemoveDatapointsRequest, Sequence[Tuple[str, str]]]:
        """Pre-rpc interceptor for remove_datapoints
    ...
    def post_remove_datapoints(
        self, response: index_service.RemoveDatapointsResponse
    ) -> index_service.RemoveDatapointsResponse:
        """Post-rpc interceptor for remove_datapoints
    ...
    def pre_update_index(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[index_service.UpdateIndexRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_upsert_datapoints(
        self,
        request: index_service.UpsertDatapointsRequest,
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[index_service.UpsertDatapointsRequest, Sequence[Tuple[str, str]]]:
        """Pre-rpc interceptor for upsert_datapoints
    ...
    def post_upsert_datapoints(
        self, response: index_service.UpsertDatapointsResponse
    ) -> index_service.UpsertDatapointsResponse:
        """Post-rpc interceptor for upsert_datapoints
...
class IndexServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: IndexServiceRestInterceptor


class IndexServiceRestTransport(IndexServiceTransport):
    """REST backend transport for IndexService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[IndexServiceRestInterceptor] = None,
        ...
        self._interceptor = interceptor or IndexServiceRestInterceptor()
    ...
    class _CreateIndex(IndexServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{parent=projects/*/locations/*}/indexes",
                    "body": "index",
                },
            ]
            request, metadata = self._interceptor.pre_create_index(request, metadata)
            pb_request = index_service.CreateIndexRequest.pb(request)
    ...
    class _DeleteIndex(IndexServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "delete",
                    "uri": "/v1beta1/{name=projects/*/locations/*/indexes/*}",
                },
            ]
            request, metadata = self._interceptor.pre_delete_index(request, metadata)
            pb_request = index_service.DeleteIndexRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetIndex(IndexServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            pb_request = index_service.GetIndexRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _ListIndexes(IndexServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            pb_request = index_service.ListIndexesRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            ...
            # Return the response
            resp = index_service.ListIndexesResponse()
            pb_resp = index_service.ListIndexesResponse.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)
            resp = self._interceptor.post_list_indexes(resp)
            return resp

    class _RemoveDatapoints(IndexServiceRestStub):
        def __hash__(self):
            return hash("RemoveDatapoints")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{index=projects/*/locations/*/indexes/*}:removeDatapoints",
                    "body": "*",
                },
            ]
            request, metadata = self._interceptor.pre_remove_datapoints(
                request, metadata
            )
            pb_request = index_service.RemoveDatapointsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            ...
            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)
            resp = self._interceptor.post_remove_datapoints(resp)
            return resp

    class _UpdateIndex(IndexServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "patch",
                    "uri": "/v1beta1/{index.name=projects/*/locations/*/indexes/*}",
                    "body": "index",
                },
            ]
            request, metadata = self._interceptor.pre_update_index(request, metadata)
            pb_request = index_service.UpdateIndexRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _UpsertDatapoints(IndexServiceRestStub):
        def __hash__(self):
            return hash("UpsertDatapoints")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the upsert datapoints method over HTTP.
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{index=projects/*/locations/*/indexes/*}:upsertDatapoints",
                    "body": "*",
                },
            ]
            request, metadata = self._interceptor.pre_upsert_datapoints(
                request, metadata
            )
            pb_request = index_service.UpsertDatapointsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            ...
            # Return the response
            resp = index_service.UpsertDatapointsResponse()
            pb_resp = index_service.UpsertDatapointsResponse.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)
            resp = self._interceptor.post_upsert_datapoints(resp)
            return resp
    ...
    def remove_datapoints(
        ...
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._RemoveDatapoints(self._session, self._host, self._interceptor)  # type: ignore
    ...
    def upsert_datapoints(
        ...
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._UpsertDatapoints(self._session, self._host, self._interceptor)  # type: ignore

    @property
    def get_location(self):
        return self._GetLocation(self._session, self._host, self._interceptor)  # type: ignore

    class _GetLocation(IndexServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.GetLocationRequest,
            *,
    ...
    class _ListLocations(IndexServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.ListLocationsRequest,
            *,
    ...
    class _GetIamPolicy(IndexServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.GetIamPolicyRequest,
            *,
    ...
    class _SetIamPolicy(IndexServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.SetIamPolicyRequest,
            *,
    ...
    class _TestIamPermissions(IndexServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.TestIamPermissionsRequest,
            *,
    ...
    class _CancelOperation(IndexServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.CancelOperationRequest,
            *,
    ...
    class _DeleteOperation(IndexServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.DeleteOperationRequest,
            *,
    ...
    class _GetOperation(IndexServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,
    ...
    class _ListOperations(IndexServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.ListOperationsRequest,
            *,
    ...
    class _WaitOperation(IndexServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.WaitOperationRequest,
            *,
...
__all__ = ("IndexServiceRestTransport",)
