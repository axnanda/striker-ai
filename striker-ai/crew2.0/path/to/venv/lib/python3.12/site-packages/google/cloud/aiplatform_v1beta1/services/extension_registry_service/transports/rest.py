...
class ExtensionRegistryServiceRestInterceptor:
    """Interceptor for ExtensionRegistryService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the ExtensionRegistryServiceRestTransport.

    .. code-block:: python
        class MyCustomExtensionRegistryServiceInterceptor(ExtensionRegistryServiceRestInterceptor):
            def pre_delete_extension(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_delete_extension(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_get_extension(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_get_extension(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_import_extension(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_import_extension(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_list_extensions(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_list_extensions(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_update_extension(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_update_extension(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = ExtensionRegistryServiceRestTransport(interceptor=MyCustomExtensionRegistryServiceInterceptor())
        client = ExtensionRegistryServiceClient(transport=transport)


    """

    def pre_delete_extension(
        self,
...
class ExtensionRegistryServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: ExtensionRegistryServiceRestInterceptor


class ExtensionRegistryServiceRestTransport(ExtensionRegistryServiceTransport):
    """REST backend transport for ExtensionRegistryService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[ExtensionRegistryServiceRestInterceptor] = None,
        ...
        self._interceptor = interceptor or ExtensionRegistryServiceRestInterceptor()
    ...
    class _DeleteExtension(ExtensionRegistryServiceRestStub):
        def __hash__(self):
            return hash("DeleteExtension")
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_delete_extension(
                request, metadata
            )
    ...
    class _GetExtension(ExtensionRegistryServiceRestStub):
        def __hash__(self):
            return hash("GetExtension")
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_get_extension(request, metadata)
    ...
    class _ImportExtension(ExtensionRegistryServiceRestStub):
        def __hash__(self):
            return hash("ImportExtension")
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_import_extension(
                request, metadata
            )
    ...
    class _ListExtensions(ExtensionRegistryServiceRestStub):
        def __hash__(self):
            return hash("ListExtensions")
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_list_extensions(request, metadata)
    ...
    class _UpdateExtension(ExtensionRegistryServiceRestStub):
        def __hash__(self):
            return hash("UpdateExtension")
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_update_extension(
                request, metadata
            )
    ...
    class _GetLocation(ExtensionRegistryServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.GetLocationRequest,
            *,
    ...
    class _ListLocations(ExtensionRegistryServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.ListLocationsRequest,
            *,
    ...
    class _GetIamPolicy(ExtensionRegistryServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.GetIamPolicyRequest,
            *,
    ...
    class _SetIamPolicy(ExtensionRegistryServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.SetIamPolicyRequest,
            *,
    ...
    class _TestIamPermissions(ExtensionRegistryServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.TestIamPermissionsRequest,
            *,
    ...
    class _CancelOperation(ExtensionRegistryServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.CancelOperationRequest,
            *,
    ...
    class _DeleteOperation(ExtensionRegistryServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.DeleteOperationRequest,
            *,
    ...
    class _ListOperations(ExtensionRegistryServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.ListOperationsRequest,
            *,
...
__all__ = ("ExtensionRegistryServiceRestTransport",)
