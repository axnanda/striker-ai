...
class VertexRagServiceAsyncClient:
    """A service for retrieving relevant contexts."""

    _client: VertexRagServiceClient

    # Copy defaults from the synchronous client for use here.
    # Note: DEFAULT_ENDPOINT is deprecated. Use _DEFAULT_ENDPOINT_TEMPLATE instead.
    DEFAULT_ENDPOINT = VertexRagServiceClient.DEFAULT_ENDPOINT
    DEFAULT_MTLS_ENDPOINT = VertexRagServiceClient.DEFAULT_MTLS_ENDPOINT
    ...
    parse_common_billing_account_path = staticmethod(
        VertexRagServiceClient.parse_common_billing_account_path
    )
    common_folder_path = staticmethod(VertexRagServiceClient.common_folder_path)
    parse_common_folder_path = staticmethod(
        VertexRagServiceClient.parse_common_folder_path
    )
    common_organization_path = staticmethod(
        VertexRagServiceClient.common_organization_path
    )
    parse_common_organization_path = staticmethod(
        VertexRagServiceClient.parse_common_organization_path
    )
    common_project_path = staticmethod(VertexRagServiceClient.common_project_path)
    parse_common_project_path = staticmethod(
        VertexRagServiceClient.parse_common_project_path
    )
    common_location_path = staticmethod(VertexRagServiceClient.common_location_path)
    ...
    def get_mtls_endpoint_and_cert_source(
        ...
        """
        return VertexRagServiceClient.get_mtls_endpoint_and_cert_source(client_options)  # type: ignore
    ...
    def transport(self) -> VertexRagServiceTransport:
        ...
        Returns:
            VertexRagServiceTransport: The transport used by the client instance.
        """
    ...
    def __init__(
        ...
        *,
        ...
        """
        self._client = VertexRagServiceClient(
    ...
    async def retrieve_contexts(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.RetrieveContextsRequest, dict]]):
    ...
    async def __aenter__(self) -> "VertexRagServiceAsyncClient":
        return self
...
__all__ = ("VertexRagServiceAsyncClient",)
