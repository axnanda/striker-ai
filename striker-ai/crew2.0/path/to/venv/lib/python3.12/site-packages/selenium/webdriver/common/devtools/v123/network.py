...
class ServiceWorkerRouterInfo:
    ...
    matched_source_type: ServiceWorkerRouterSource
    ...
    def from_json(cls, json):
        return cls(
            rule_id_matched=int(json['ruleIdMatched']),
            matched_source_type=ServiceWorkerRouterSource.from_json(json['matchedSourceType']),
        )
...
def delete_cookies(
    ...
    :param partition_key: *(Optional)* If specified, deletes only cookies with the the given name and partitionKey where domain matches provided URL.
    '''
    params: T_JSON_DICT = dict()
    params['name'] = name
    if url is not None:
