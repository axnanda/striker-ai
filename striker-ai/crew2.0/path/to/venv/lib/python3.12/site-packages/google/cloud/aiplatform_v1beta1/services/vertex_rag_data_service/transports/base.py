...
class VertexRagDataServiceTransport(abc.ABC):
    """Abstract transport class for VertexRagDataService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.create_rag_corpus: gapic_v1.method.wrap_method(
            ...
            self.list_rag_corpora: gapic_v1.method.wrap_method(
                self.list_rag_corpora,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_rag_corpus: gapic_v1.method.wrap_method(
                self.delete_rag_corpus,
                default_timeout=None,
                client_info=client_info,
            ),
            self.upload_rag_file: gapic_v1.method.wrap_method(
                self.upload_rag_file,
                default_timeout=None,
                client_info=client_info,
            ),
            self.import_rag_files: gapic_v1.method.wrap_method(
                self.import_rag_files,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_rag_file: gapic_v1.method.wrap_method(
                self.get_rag_file,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_rag_files: gapic_v1.method.wrap_method(
                self.list_rag_files,
                default_timeout=None,
                client_info=client_info,
            ),
    ...
    def get_rag_corpus(
        ...
        Union[vertex_rag_data.RagCorpus, Awaitable[vertex_rag_data.RagCorpus]],
    ]:
        raise NotImplementedError()
    ...
    def get_rag_file(
        ...
        Union[vertex_rag_data.RagFile, Awaitable[vertex_rag_data.RagFile]],
    ]:
        raise NotImplementedError()
...
__all__ = ("VertexRagDataServiceTransport",)
