...
class VertexRagServiceGrpcAsyncIOTransport(VertexRagServiceTransport):
    """gRPC AsyncIO backend transport for VertexRagService.
    ...
    def retrieve_contexts(
        ...
        r"""Return a callable for the retrieve contexts method over gRPC.

        Retrieves relevant contexts for a query.

        Returns:
            Callable[[~.RetrieveContextsRequest],
                    Awaitable[~.RetrieveContextsResponse]]:
        ...
        if "retrieve_contexts" not in self._stubs:
            self._stubs["retrieve_contexts"] = self.grpc_channel.unary_unary(
                "/google.cloud.aiplatform.v1beta1.VertexRagService/RetrieveContexts",
                request_serializer=vertex_rag_service.RetrieveContextsRequest.serialize,
                response_deserializer=vertex_rag_service.RetrieveContextsResponse.deserialize,
            )
...
__all__ = ("VertexRagServiceGrpcAsyncIOTransport",)
