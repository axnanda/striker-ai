...
from .transports.grpc import VertexRagServiceGrpcTransport
from .transports.grpc_asyncio import VertexRagServiceGrpcAsyncIOTransport
from .transports.rest import VertexRagServiceRestTransport


class VertexRagServiceClientMeta(type):
    """Metaclass for the VertexRagService client.
    ...
    _transport_registry = (
        OrderedDict()
    )  # type: Dict[str, Type[VertexRagServiceTransport]]
...
class VertexRagServiceClient(metaclass=VertexRagServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            VertexRagServiceClient: The constructed client.
        """
    ...
    def transport(self) -> VertexRagServiceTransport:
        ...
        Returns:
            VertexRagServiceTransport: The transport used by the client
                instance.
        """
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = VertexRagServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = VertexRagServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = VertexRagServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or VertexRagServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, VertexRagServiceTransport]] = None,
        ...
        self._client_cert_source = VertexRagServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = VertexRagServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, VertexRagServiceTransport)
        if transport_provided:
            # transport is a VertexRagServiceTransport instance.
            ...
            self._transport = cast(VertexRagServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or VertexRagServiceClient._get_api_endpoint(
    ...
    def retrieve_contexts(
        self,
        request: Optional[
            Union[vertex_rag_service.RetrieveContextsRequest, dict]
        ] = None,
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.RetrieveContextsRequest, dict]):
        ...
        # in a vertex_rag_service.RetrieveContextsRequest.
        ...
        rpc = self._transport._wrapped_methods[self._transport.retrieve_contexts]
    ...
    def __enter__(self) -> "VertexRagServiceClient":
        return self
...
__all__ = ("VertexRagServiceClient",)
