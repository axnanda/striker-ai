...
from .base import MatchServiceTransport, DEFAULT_CLIENT_INFO as BASE_DEFAULT_CLIENT_INFO
...
class MatchServiceRestInterceptor:
    """Interceptor for MatchService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the MatchServiceRestTransport.

    .. code-block:: python
        class MyCustomMatchServiceInterceptor(MatchServiceRestInterceptor):
            def pre_find_neighbors(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_find_neighbors(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_read_index_datapoints(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_read_index_datapoints(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = MatchServiceRestTransport(interceptor=MyCustomMatchServiceInterceptor())
        client = MatchServiceClient(transport=transport)


    """

    def pre_find_neighbors(
        self,
    ...
    def post_read_index_datapoints(
...
class MatchServiceRestStub:
    _session: AuthorizedSession
    _host: str
    _interceptor: MatchServiceRestInterceptor


class MatchServiceRestTransport(MatchServiceTransport):
    """REST backend transport for MatchService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[MatchServiceRestInterceptor] = None,
        ...
        self._interceptor = interceptor or MatchServiceRestInterceptor()
        self._prep_wrapped_messages(client_info)

    class _FindNeighbors(MatchServiceRestStub):
        def __hash__(self):
            return hash("FindNeighbors")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:findNeighbors",
                    "body": "*",
                },
            ]
            request, metadata = self._interceptor.pre_find_neighbors(request, metadata)
            pb_request = match_service.FindNeighborsRequest.pb(request)
    ...
    class _ReadIndexDatapoints(MatchServiceRestStub):
        def __hash__(self):
            return hash("ReadIndexDatapoints")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{index_endpoint=projects/*/locations/*/indexEndpoints/*}:readIndexDatapoints",
                    "body": "*",
                },
            ]
            request, metadata = self._interceptor.pre_read_index_datapoints(
                request, metadata
            )
            pb_request = match_service.ReadIndexDatapointsRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetLocation(MatchServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.GetLocationRequest,
            *,
    ...
    class _ListLocations(MatchServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.ListLocationsRequest,
            *,
    ...
    class _GetIamPolicy(MatchServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.GetIamPolicyRequest,
            *,
    ...
    class _SetIamPolicy(MatchServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.SetIamPolicyRequest,
            *,
    ...
    class _TestIamPermissions(MatchServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.TestIamPermissionsRequest,
            *,
    ...
    class _CancelOperation(MatchServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.CancelOperationRequest,
            *,
    ...
    class _DeleteOperation(MatchServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.DeleteOperationRequest,
            *,
    ...
    class _GetOperation(MatchServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,
    ...
    class _ListOperations(MatchServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.ListOperationsRequest,
            *,
    ...
    class _WaitOperation(MatchServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.WaitOperationRequest,
            *,
...
__all__ = ("MatchServiceRestTransport",)
