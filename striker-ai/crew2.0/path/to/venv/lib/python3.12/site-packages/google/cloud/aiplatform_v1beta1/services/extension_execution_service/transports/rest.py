...
class ExtensionExecutionServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def pre_execute_extension(
        self,
        request: extension_execution_service.ExecuteExtensionRequest,
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[
        extension_execution_service.ExecuteExtensionRequest, Sequence[Tuple[str, str]]
    ]:
    ...
    def pre_query_extension(
        ...
        extension_execution_service.QueryExtensionRequest, Sequence[Tuple[str, str]]
    ]:
...
class ExtensionExecutionServiceRestTransport(ExtensionExecutionServiceTransport):
    """REST backend transport for ExtensionExecutionService.
    ...
    class _ExecuteExtension(ExtensionExecutionServiceRestStub):
        def __hash__(self):
            return hash("ExecuteExtension")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{name=projects/*/locations/*/extensions/*}:execute",
                    "body": "*",
                },
            ]
            request, metadata = self._interceptor.pre_execute_extension(
                request, metadata
            )
            pb_request = extension_execution_service.ExecuteExtensionRequest.pb(request)
    ...
    class _QueryExtension(ExtensionExecutionServiceRestStub):
        def __hash__(self):
            return hash("QueryExtension")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{name=projects/*/locations/*/extensions/*}:query",
                    "body": "*",
                },
            ]
            request, metadata = self._interceptor.pre_query_extension(request, metadata)
            pb_request = extension_execution_service.QueryExtensionRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
    ...
    class _GetLocation(ExtensionExecutionServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.GetLocationRequest,
            *,
    ...
    class _ListLocations(ExtensionExecutionServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.ListLocationsRequest,
            *,
    ...
    class _GetIamPolicy(ExtensionExecutionServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.GetIamPolicyRequest,
            *,
    ...
    class _SetIamPolicy(ExtensionExecutionServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.SetIamPolicyRequest,
            *,
    ...
    class _TestIamPermissions(ExtensionExecutionServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.TestIamPermissionsRequest,
            *,
    ...
    class _CancelOperation(ExtensionExecutionServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.CancelOperationRequest,
            *,
    ...
    class _GetOperation(ExtensionExecutionServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,
    ...
    class _WaitOperation(ExtensionExecutionServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.WaitOperationRequest,
            *,
...
__all__ = ("ExtensionExecutionServiceRestTransport",)
