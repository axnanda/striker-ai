...
from .transports.grpc import ExtensionRegistryServiceGrpcTransport
...
class ExtensionRegistryServiceClient(metaclass=ExtensionRegistryServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ExtensionRegistryServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ExtensionRegistryServiceTransport:
        ...
        Returns:
            ExtensionRegistryServiceTransport: The transport used by the client
                instance.
        """
    ...
    def extension_path(
        ...
        return "projects/{project}/locations/{location}/extensions/{extension}".format(
            project=project,
            location=location,
            extension=extension,
        )
    ...
    @staticmethod
    def parse_extension_path(path: str) -> Dict[str, str]:
        """Parses a extension path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/extensions/(?P<extension>.+?)$",
            path,
        )
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = ExtensionRegistryServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = (
                ExtensionRegistryServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = ExtensionRegistryServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or ExtensionRegistryServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, ExtensionRegistryServiceTransport]] = None,
        ...
        transport_provided = isinstance(transport, ExtensionRegistryServiceTransport)
        if transport_provided:
            # transport is a ExtensionRegistryServiceTransport instance.
            ...
            self._transport = cast(ExtensionRegistryServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or ExtensionRegistryServiceClient._get_api_endpoint(
    ...
    def import_extension(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.ImportExtensionRequest, dict]):
        ...
        # in a extension_registry_service.ImportExtensionRequest.
        ...
        rpc = self._transport._wrapped_methods[self._transport.import_extension]
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_extension():
                ...
                # Make the request
                response = client.get_extension(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.GetExtensionRequest, dict]):
                The request object. Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a extension_registry_service.GetExtensionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_extension]
    ...
    def list_extensions(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.ListExtensionsRequest, dict]):
                The request object. Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a extension_registry_service.ListExtensionsRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_extensions]
        ...
        response = pagers.ListExtensionsPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_update_extension():
                ...
                # Make the request
                response = client.update_extension(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.UpdateExtensionRequest, dict]):
                The request object. Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a extension_registry_service.UpdateExtensionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_extension]
    ...
    def delete_extension(
        ...
        *,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.DeleteExtensionRequest, dict]):
                The request object. Request message for
        ...
        # Minor optimization to avoid making a copy if the user passes
        # in a extension_registry_service.DeleteExtensionRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_extension]
    ...
    def __enter__(self) -> "ExtensionRegistryServiceClient":
        return self
...
__all__ = ("ExtensionRegistryServiceClient",)
