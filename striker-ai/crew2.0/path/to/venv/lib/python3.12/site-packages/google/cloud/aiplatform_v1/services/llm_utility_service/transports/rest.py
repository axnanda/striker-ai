...
class LlmUtilityServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    ) -> Tuple[llm_utility_service.ComputeTokensRequest, Sequence[Tuple[str, str]]]:
    ...
    def pre_count_tokens(
        ...
        metadata: Sequence[Tuple[str, str]],
    ) -> Tuple[prediction_service.CountTokensRequest, Sequence[Tuple[str, str]]]:
...
class LlmUtilityServiceRestTransport(LlmUtilityServiceTransport):
    """REST backend transport for LlmUtilityService.
    ...
    class _ComputeTokens(LlmUtilityServiceRestStub):
        def __hash__(self):
            return hash("ComputeTokens")
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{endpoint=projects/*/locations/*/endpoints/*}:computeTokens",
                    "body": "*",
                },
                {
                    "method": "post",
    ...
    class _CountTokens(LlmUtilityServiceRestStub):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1/{endpoint=projects/*/locations/*/endpoints/*}:countTokens",
                    "body": "*",
                },
                {
                    "method": "post",
    ...
    class _GetLocation(LlmUtilityServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.GetLocationRequest,
            *,
    ...
    class _ListLocations(LlmUtilityServiceRestStub):
        def __call__(
            self,
            request: locations_pb2.ListLocationsRequest,
            *,
    ...
    class _GetIamPolicy(LlmUtilityServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.GetIamPolicyRequest,
            *,
    ...
    class _SetIamPolicy(LlmUtilityServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.SetIamPolicyRequest,
            *,
    ...
    class _TestIamPermissions(LlmUtilityServiceRestStub):
        def __call__(
            self,
            request: iam_policy_pb2.TestIamPermissionsRequest,
            *,
    ...
    class _CancelOperation(LlmUtilityServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.CancelOperationRequest,
            *,
    ...
    class _DeleteOperation(LlmUtilityServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.DeleteOperationRequest,
            *,
    ...
    class _GetOperation(LlmUtilityServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.GetOperationRequest,
            *,
    ...
    class _ListOperations(LlmUtilityServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.ListOperationsRequest,
            *,
    ...
    class _WaitOperation(LlmUtilityServiceRestStub):
        def __call__(
            self,
            request: operations_pb2.WaitOperationRequest,
            *,
