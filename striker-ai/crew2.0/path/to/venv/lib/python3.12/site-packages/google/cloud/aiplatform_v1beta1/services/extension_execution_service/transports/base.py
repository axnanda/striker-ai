...
class ExtensionExecutionServiceTransport(abc.ABC):
    """Abstract transport class for ExtensionExecutionService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.execute_extension: gapic_v1.method.wrap_method(
                self.execute_extension,
                default_timeout=None,
                client_info=client_info,
            ),
            self.query_extension: gapic_v1.method.wrap_method(
...
__all__ = ("ExtensionExecutionServiceTransport",)
