...
class EvaluationServiceClient(metaclass=EvaluationServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[Union[str, EvaluationServiceTransport]] = None,
        ...
        Args:
            ...
            transport (Union[str, EvaluationServiceTransport]): The
    ...
    def evaluate_instances(
        self,
        request: Optional[
            Union[evaluation_service.EvaluateInstancesRequest, dict]
        ] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_evaluate_instances():
                ...
                request = aiplatform_v1beta1.EvaluateInstancesRequest(
                    location="location_value",
                )

                # Make the request
                response = client.evaluate_instances(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.EvaluateInstancesRequest, dict]):
        ...
        # in a evaluation_service.EvaluateInstancesRequest.
        # There's no risk of modifying the input as we've already verified
        # there are no flattened fields.
        if not isinstance(request, evaluation_service.EvaluateInstancesRequest):
            request = evaluation_service.EvaluateInstancesRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.evaluate_instances]
