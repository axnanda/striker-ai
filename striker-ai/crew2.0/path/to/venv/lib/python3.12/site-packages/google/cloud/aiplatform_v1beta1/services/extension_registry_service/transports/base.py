...
class ExtensionRegistryServiceTransport(abc.ABC):
    """Abstract transport class for ExtensionRegistryService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.import_extension: gapic_v1.method.wrap_method(
                self.import_extension,
                default_timeout=None,
                client_info=client_info,
            ),
            self.get_extension: gapic_v1.method.wrap_method(
                self.get_extension,
                default_timeout=None,
                client_info=client_info,
            ),
            self.list_extensions: gapic_v1.method.wrap_method(
                self.list_extensions,
                default_timeout=None,
                client_info=client_info,
            ),
            self.update_extension: gapic_v1.method.wrap_method(
                self.update_extension,
                default_timeout=None,
                client_info=client_info,
            ),
            self.delete_extension: gapic_v1.method.wrap_method(
    ...
    def get_extension(
        ...
        Union[extension.Extension, Awaitable[extension.Extension]],
    ]:
        raise NotImplementedError()
    ...
    def update_extension(
        ...
        Union[gca_extension.Extension, Awaitable[gca_extension.Extension]],
    ]:
        raise NotImplementedError()
...
__all__ = ("ExtensionRegistryServiceTransport",)
