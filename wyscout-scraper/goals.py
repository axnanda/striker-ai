...
def extract_and_format_data(pdf_path, page_number, filter):
    data_format =["Min. played", "Goals/xG", "Assists/xA", "Actions/successful", 
                   "Shots/on target", "Passes/accurate", "Crosses/accurate", "Dribbles/successful", 
                   "Duels/won", "Losses/own half", "Recoveries/opponent half", "Touches in penalty area", "Offsides", "Yellow/Red cards"] 
    formatted_data = []
...
json_output_filename = f'combined_goals_tables_{timestamp}.json'
